<?php 
     ...
     */ 
    class ShiptimizeShippingCTTFree extends WC_Shipping_Free_Shipping { 
        /**
         * Constructor.
         *
        ...
        public function __construct( $instance_id = 0){
          ...
          $this->id = 'shipping_shiptimize_30_free';
          $this->method_title = 'Shiptimize: CTT Free Shipping'; //name for admin 
          $this->method_description = 'Shiptimize CTT Free Shipping'; // description for admin 
...
$this->instance_form_fields['fragile'] = array(
        ...
        public function get_admin_options_html()
        {
          ...
          function setExcludeClasses() {
            ...
            var select = jQuery("#woocommerce_shipping_shiptimize_30_free_excludeclasses"); 
            var content = select.parent();
            select.remove();  
            for ( var x=0; x< excludeoptions.length; ++x ) { 
              content.append(\'<span class="shiptimize-ib shiptimize-exclude-class"> <input type="checkbox" name="woocommerce_shipping_shiptimize_30_free_excludeclasses[]" value="\' + excludeoptions[x].id + \'" \' + excludeoptions[x].selected + \' /> \' + excludeoptions[x].name + \'</span>\');
            }
          }
          </script>';
        }
