...
class ShiptimizeOrderUI {
  ...
  */ 
  ...
  public function ajax_print_label() {
    ...
    die(json_encode(WooShiptimizeOrder::print_label(array($orderid))));
  }
  ...
  public function order_columns( $columns ) {
    ...
    $columns['shiptimize_status'] = SHIPTIMIZE_BRAND . ' ' . $shiptimize->translate('shiptimizecolumntitle');  
    return $columns; 
  }
